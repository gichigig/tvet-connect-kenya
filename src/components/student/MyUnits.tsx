...
import { UnitCard } from "./units/UnitCard.tsx";
...
import { StudentCampusRegistration } from "./registration/StudentCampusRegistration";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export const MyUnits = () => {
  ...
  const checkSemesterReport = async () => {
    ...
    try {
      // Mock semester report check - replace with Supabase implementation
        ...
        <Card className="border-gray-200 bg-gray-50">
          <CardHeader className="pb-3">
            ...
            <CardDescription className="text-gray-600">
              ...
              {hasNewUnitsToSync && (
                <span className="text-blue-600 ml-2">Ã¢â‚¬Â¢ New units available</span>
              )}
            </CardDescription>
          </CardHeader>
        </Card>
