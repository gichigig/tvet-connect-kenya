  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <DashboardHeader 
        ...
        subtitle={`Welcome ${user?.firstName} ${user?.lastName} - Manage your courses, assignments, and student activities`}
        notificationCount={uniqueAssignments.length + uniqueExams.length}
      />
                  ...
                  >
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-blue-600 font-medium">View Details Ã¢â€ â€™</span>
                      </div>
                    </div>
                  </div>
                ))}
