            ...
            <TabsContent value="planning" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-sm">
                      {departments.map(dept => {
                        ...
                        return (
                          <li key={dept}>Ã¢â‚¬Â¢ {dept}: {deptUsers} staff, {deptStudents} students</li>
                        );
                      })}
                    </ul>
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-sm">
                      <li>Ã¢â‚¬Â¢ Fee Collection Rate: {totalPaidFees > 0 ? ((totalPaidFees / projectedStudentFees) * 100).toFixed(1) : 0}%</li>
                      <li>Ã¢â‚¬Â¢ Staff-to-Student Ratio: 1:{Math.round(students.length / staffCount)}</li>
                      <li>Ã¢â‚¬Â¢ Revenue per Student: KSh {(totalProjectedRevenue / students.length).toLocaleString()}</li>
                      <li>Ã¢â‚¬Â¢ Budget Utilization: {utilizationRate}%</li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-sm">
                      <li>Ã¢â‚¬Â¢ Emergency Fund: {((totalProjectedRevenue * 0.1) / 1000000).toFixed(1)}M</li>
                      <li>Ã¢â‚¬Â¢ Diversified Revenue Sources</li>
                      <li>Ã¢â‚¬Â¢ Real-time Budget Monitoring</li>
                      <li>Ã¢â‚¬Â¢ Automated Financial Controls</li>
                    </ul>
                  </CardContent>
                </Card>
              </div>
