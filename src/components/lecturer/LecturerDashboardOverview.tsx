      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="text-sm text-gray-600">
            <p>Ã¢â‚¬Â¢ Click on any unit to manage its content</p>
            <p>Ã¢â‚¬Â¢ Add assignments, CATs, exams, and notes</p>
            <p>Ã¢â‚¬Â¢ Set up WhatsApp groups for communication</p>
            <p>Ã¢â‚¬Â¢ Schedule online classes</p>
          </div>
        </CardContent>
      </Card>
