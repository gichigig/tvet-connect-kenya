...
export const AddStudentForm: React.FC = () => {
  ...
  // Additional form fields not in CreateStudentData interface
  ...
  const filteredCourses = courses.filter(course => {
    ...
    // Include all courses for now since status property doesn't exist
    ...
    console.log('Course filter debug:', {
      ...
      courseStatus: 'active', // Default since status property doesn't exist
      selectedDepartment,
  ...
  const availableDepartments = departments.map(dept => dept.name);
  ...
  const handleInputChange = useCallback((field: keyof CreateStudentData, value: string | number | Date) => {
    setFormData(prev => ({
      ...prev,
      [field]: value,
    }));
  ...
  const handleAdditionalDataChange = useCallback((field: string, value: string | number) => {
  ...
  const handleSemesterChange = useCallback((value: string) => {
    handleAdditionalDataChange('semester', parseInt(value));
  }, [handleAdditionalDataChange]);
  ...
  const validateStep = (step: number): boolean => {
    switch (step) {
      ...
      case 2:
        return !!(additionalData.department && formData.course && additionalData.level);
      case 3:
        return !!password;
      case 4:
  ...
  const handleCreateStudent = async () => {
    ...
    try {
      ...
      const newStudent = await createStudent(formData, password);
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                      ...
                      {availableDepartments.map((dept) => {
                        ...
                        return (
                          <SelectItem key={dept} value={dept}>
                            {dept} {hasCourses ? 'Ã¢Å“â€œ' : '(no courses)'}
                          </SelectItem>
                        );
                      })}
                    </SelectContent>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Ã¢Å“â€œ indicates departments with available courses
                  </p>
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <Select value={formData.yearOfStudy.toString()} onValueChange={handleYearChange}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div>
                  ...
                  <Select value={additionalData.semester.toString()} onValueChange={handleSemesterChange}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div>
                  ...
                  <Input
                    id="academicYear"
                    value={additionalData.academicYear}
